export const translations = {
	...
	decisionMoreInfo: {
		...
		"sv-FI":
			"Mer information om hur man söker sig till serviceboende med heldygnsomsorg och om klientkriterierna.",
	},
	urlDecisionMoreInfo: {
		"fi-FI":
	...
	serviceDescriptionLink: {
		...
		"sv-FI": "Kolla in servicekonceptet",
	},
	urlServiceDescription: {
		"fi-FI": "https://www.espoo.fi",
		"sv-FI": "https://espoo.fi/sv-FI",
	},
	faqSectionHeadline: {
	...
	faqItem1Headline: {
		...
		"sv-FI": "Hurdana är bostäderna och kan partner bo tillsammans?",
	},
	faqItem1Text: {
		"fi-FI":
	...
	faqItem7Headline: {
		...
		"sv-FI": "Får klienten nödvändiga hjälpmedel av vårdhemmet?",
	},
	faqItem7Text: {
		"fi-FI":
	...
	filterLAHText: {
		"fi-FI": "Näytä lyhytaikaista asumista tarjoavat hoivakodit.",
		"sv-FI": "Visa de vårdhem som erbjuder kortvarigt boende",
	},
	alsoLAHText: {
		"fi-FI": "Myös lyhytaikaista asumista",
		"sv-FI": "Också kortvarigt boende",
	},
	...
	webpage: {
		"fi-FI": "Hoivakodin verkkosivut",
		"sv-FI": "Vårdhemmets webbplats",
	},
	linkMoreInfoOutdoor: {
	...
	linkMoreInfoActivies: {
		...
		"sv-FI": "Läs mera om aktiviteter",
	},
	linkMoreInfoPersonnel: {
		"fi-FI": "Lisätietoa henkilöstön tyytyväisyydestä",
		"sv-FI": "Läs mera om personnel",
	},
	...
	whatServicesIncludesContent1: {
		"fi-FI":
			"Kaikki Hoivakotiportaalissa esiteltävät hoivakodit noudattavat Länsi-Uudenmaankuntien yhteisiä periaatteita palvelun sisällöstä ja laadusta. <0>Lue lisää palvelukonseptista</0>.",
		"sv-FI":
			"Alla vårdhem som presenteras i Vårdhemsportalen följer Västra Nylands kommuners gemensamma principer för servicens innehåll och kvalitet. <0>Läs mer om servicekonceptet</0> (den svenska version är på kommande).",
	},
