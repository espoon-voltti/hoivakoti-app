...
const PUBLIC_FILES_URL = window.location.protocol + "//" + window.location.hostname + publicFilesPortString;

const apiPortString = NODE_ENV === "development" ? ":3000" : "";
const API_URL = window.location.protocol + "//" + window.location.hostname + apiPortString + "/api";
